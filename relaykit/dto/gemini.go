...
type FunctionCall struct {
	// ID is optional in the Gemini protocol and identifies the matching function
	// response: Gemini can pair them positionally. A channel that relays on to
	// Anthropic cannot, which rejects the request with
	// "content.0.tool_use.id: Field required".
