...
export function ChatRecordSection({
  ...
  async function onSubmit(values: Values) {
    ...
    push('chat_record_setting.store_files', values.storeFiles, saved.storeFiles)
        ...
        <SettingsForm onSubmit={form.handleSubmit(onSubmit)} autoComplete='off'>
          ...
          <FormField
            ...
            render={({ field }) => (
              <SettingsSwitchItem>
                <SettingsSwitchContent>
                  <FormLabel>
                    {t('Let the person observe the assistant')}
                  </FormLabel>
                  <FormDescription>
                    {t(
          ...
          <FormField
            ...
            render={({ field }) => (
              <SettingsSwitchItem>
                <SettingsSwitchContent>
                  <FormLabel>
                    {t('Let the assistant observe the person')}
                  </FormLabel>
                  <FormDescription>
                    {t(
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>
                  {t('Memory ceiling for the memory queue (MB)')}
                </FormLabel>
                <FormControl>
                  <Input type='number' min={1} {...field} />
                </FormControl>
